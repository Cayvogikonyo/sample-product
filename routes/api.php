...
// Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('product-suppliers', [SupplierController::class, 'supplyProducts'])->name('product-suppliers');
    ...
    Route::post('new-supplier', [SupplierController::class, 'saveSupplierProduct'])->name('new-supplier');
