                ...
                <div>
                    <div class="p-6">
                        <div class="flex items-center">
                            <div class="ml-4 text-lg leading-7 text-white font-semibold"><a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">Welcome to</a></div>
                        </div>

                        <div class="ml-12">
                            <img src="/images/ZE.gif" />
                        </div>
                    </div>
                </div>
            </div>
